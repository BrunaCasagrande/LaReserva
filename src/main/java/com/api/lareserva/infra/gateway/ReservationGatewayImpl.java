...
public class ReservationGatewayImpl implements ReservationGateway {
    ...
    public Reservation save(final Reservation reservation) {
        final var entity = ReservationEntity.builder()
    ...
    @Override
    public List<Reservation> findByRestaurantAndDate(final Integer restaurantId, final Date reservationDate) {
    ...
    public Reservation update(final Reservation reservation) {
        final var entity = reservationRepository.findById(reservation.getId())
                .orElseThrow(() -> new GatewayException(format(FIND_ERROR_MESSAGE, reservation.getId())));
